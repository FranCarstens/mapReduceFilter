...
log(reduce([1, 2, 3, 4], function(accumulator, element){ return accumulator * element }) === 24)
log(reduce([1, 2, 3, 4], function(accumulator, element){ return accumulator + element }) === 10)}
